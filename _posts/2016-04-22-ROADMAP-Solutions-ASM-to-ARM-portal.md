...
Right now the solutions to help with "Azure Service Management or ASM portal (older)" to "Azure Resource Manager or ARM portal (newer)" are limited to only a set of scripts provided by Microsoft. The same can be found on [GitHub on ASM2ARM page.](https://github.com/fullscale180/asm2arm){:target="_blank"}
